...
public function AdminRolesUpdate(Request $request, $id){
    ...
    // Retrieve existing permissions associated with the web guard
    $permissions = Permission::where('guard_name', 'web')->whereIn('id', $permissionIds)->get();

    // Sync only existing permissions
